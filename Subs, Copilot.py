## Extrator de Legendas MKV com Interface Gráfica em PyQt6
# Este script cria uma aplicação GUI para extrair faixas de legenda de arquivos de vídeo .mkv.
# Ele utiliza ffmpeg e mkvextract para identificar e extrair faixas de legenda, permitindo ao usuário
# selecionar a pasta de entrada, a pasta de saída, e opções como sobrescrever arquivos existentes

## Produzido com o Copilot
# https://copilot.microsoft.com/chats/LbkgsaLebU76VGnKmMfor
