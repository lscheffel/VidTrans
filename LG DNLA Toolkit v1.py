...
class Job:
    ...
    crf: int = 20
    abr_kbps: int = 192
    lang_filters: List[str] = field(default_factory=lambda: ["por","pob", "pt", "pt-br"])
...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def _build_ui(self):
        ...
        ext_layout.addWidget(QtWidgets.QLabel("Legendas (multi-select) — pré: por, pob, pt, pt-br"), 3, 0)
        ...
        for key in ["por", "pob", "pt-br", "pt","en","es","fr","de","it","ja","zh"]:
